			...
			<div class="col-lg-12">
				...
				<table class="table">
					...
					System.out.print("ID "+id);
						...
						PreparedStatement ps  = con.prepareStatement("SELECT * FROM `appoinment_details` where d_id='"+id+"' AND status='Check' ORDER BY id DESC");
						...
						<tr>
							...
							<td><a href="dr_checkPrescription.jsp?id=<%=rs.getString("id") %>">Check Prescription</a></td>
