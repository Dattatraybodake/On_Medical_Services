...
<jsp:include page="header/alertBox.jsp"></jsp:include>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 align="center">Patient View Prescription</h2>
				<hr />
				<p align="right">
			...
			<div class="col-lg-6">
				...
				<form action="RequestResponse" method="POST">
					...
					<table class="table" align="center">
						<tr>
							<th>Prescription</th>
							<td><textarea readonly rows="3" cols="20" name="prescription" required class="form-control"><%=rs.getString("prescription") %></textarea></td>
						</tr>
						<tr>
							<th>Lab Report</th>
							<td><textarea readonly rows="3" cols="20" name="lab_report" required class="form-control"><%=rs.getString("lab_report") %></textarea></td>
						</tr>
						<tr>
							<td>Date</td>
