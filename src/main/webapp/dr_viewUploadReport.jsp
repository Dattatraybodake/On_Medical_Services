				...
				<div class="row">
					<div class="col-lg-12" align="center">
					 ...
					 String dr_id=session.getAttribute("id").toString();
						...
						PreparedStatement ps  = con.prepareStatement("SELECT * FROM `report_details` where refer_by_dr_id='"+dr_id+"'");
						...
						while(rs.next())
						{
							...
							HashMap<String,String> r_dr_details=gf.getDr_Details(rs.getString("refer_by_dr_id"));
						...
						%>
								...
								<tr>
									...
									<td><%=r_dr_details.get("fname") %>&nbsp;<%=r_dr_details.get("mname") %>&nbsp;<%=r_dr_details.get("lname") %></td>
