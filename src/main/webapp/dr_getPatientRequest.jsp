		...
		<div class="row">
			<div class="col-lg-12">
				<div class="row">
					...
					<h2>Appointment Request From Patient</h2>
					<hr/>
					...
					System.out.print("ID "+id);
						...
						PreparedStatement ps  = con.prepareStatement("SELECT * FROM `appoinment_details` where d_id='"+id+"' AND status='Waitting' ORDER BY id DESC");
						...
						<tr>
							...
							<td><a href="UpdateRequest?id=<%=rs.getString("id") %>&sts=Accept">Accept</a>&nbsp;|&nbsp;<a href="UpdateRequest?id=<%=rs.getString("id") %>&sts=Reject">Reject</a> </td>

							<%-- <td><a href="CancelRequest?id=<%=rs.getString("id")%>">Cancel Appointment</a> </td> --%>
						</tr>
