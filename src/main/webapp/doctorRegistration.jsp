...
<jsp:include page="header/alertBox.jsp"></jsp:include>
	...
	<div class="container">
		...
		<div class="section-title">
			<h2>Doctor/Pathology Lab Registration</h2>
		</div>
			<form action="DoctorRegistration" method="post" name="ureg">
				<table align="center">
					<tr>
						<th>Full Name</th>
						<td><input type="text" placeholder="First Name" class="form-control" name="fname" required onkeyup="AllowAlphabet0()"></td>
						<td><input type="text" placeholder="Middle Name" class="form-control" name="mname" required onkeyup="AllowAlphabet1()"></td>
						<td><input type="text" placeholder="Last Name" class="form-control" name="lname" required onkeyup="AllowAlphabet2()"></td>
					</tr>
					<tr>
						<th>Birth Date</th>
					...
					<tr>
						...
						<td><input type="text" placeholder="Your Aadhar Number"
							class="form-control" name="adhar_id" required></td>
					</tr>
					
					<tr>
						<th>Account Type</th>
						<td><input type="radio" value="Doctor" name="acc_type" >Doctor&nbsp;&nbsp;<input type="radio" value="PathologyLab" name="acc_type">PathologyLab</td>
						<th>Working Area</th>
						<td><input type="text" placeholder="Working Area"
							class="form-control" name="area_name" required></td>
					</tr>
					
					<tr>
						<th>Address In Details</th>
						<td><textarea rows="3" cols="30" name="address" required placeholder="Address in Details"></textarea></td>
						
						<th>Qualification</th>
						<td><select class="form-control" name="qualification">
							<option value="MD">Doctor of Medicine</option>
							<option value="Homeopethic and surgery">Bachelor of Homeopethic and surgery</option>
							<option value="Ayurvedic Medicine and Surgery">Bachelor of Ayurvedic Medicine and Surgery</option>
							<option value="Nursing">BSC Nursing </option>
							<option value="Pathology">BSc-Pathology</option>
							<option value="Forensic Medicine"> Bachelor of Forensic Medicine</option>
							<option value="Speech Theropy"> Bachelor of Speech Theropy</option>
							<option value="Siddha Medicine and Surgery"> Bachelor of Siddha Medicine and Surgery</option>
							<option value="Unani Medicine and Surgery"> Bachelor of Unani Medicine and Surgery</option>
							<option value="Occupational Theropy">Bachelor of Occupational Theropy</option>
							<option value="Dental Surgery"> Bachelor of Dental Surgery</option>
							<option value="Naturopathy and Yogic Science"> Bachelor of Naturopathy and Yogic Science</option>
							<option value="Medical Lab Technology"> Bachelor of Medical Lab Technology</option>
							<option value="Phisio Theropy">Bachelor of Phisio Theropy</option>
							<option value="Pharmacy"> Bachelor of Pharmacy</option>
							<option value="Clinical Pathology">Diploma in Clinical Pathology</option>
							<option value="Opthalmology"> Diploma in Opthalmology</option>
							<option value="Pathology"> Diploma in Pathology</option>
							<option value="Radiotheropy"> Diploma in Radiotheropy</option>
							<option value="Psyciastric"> Diploma in Psyciastric</option>						
						</select></td>
					</tr>
					<tr>
					...
					<tr>
						<th>Email ID</th>
						<td><input type="text" placeholder="Your Email ID" 	onblur="return validateEmail()"
							class="form-control" name="email" required></td>
					</tr>
					<tr>
						<th>Password</th>
						<td><input type="password" placeholder="************" onblur="return validatepassword()"
