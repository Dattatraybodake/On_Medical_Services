		...
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<form action="RequestResponse" method="POST">
					...
					<table class="table" align="center">
						<tr>
							<th>Prescription<input type="hidden" name="id" value="<%=id%>"> </th>
							<td><textarea rows="4" cols="20" name="prescription" required class="form-control"></textarea></td>
						</tr>
							<tr>
							<th>Pathology Lab Report</th>
							<td><textarea rows="4" cols="20" name="lab_report" required class="form-control"></textarea></td>
						</tr>
