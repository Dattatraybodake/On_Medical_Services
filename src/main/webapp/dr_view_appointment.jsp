				...
				<div class="row">
					...
					<%
					 ...
					 String id=session.getAttribute("id").toString();
						...
						PreparedStatement ps  = con.prepareStatement("SELECT * FROM `appoinment_details` where d_id='"+id+"' AND status='Accept' ORDER BY id DESC");
						...
						<tr>
							...
							<td><a href="dr_checkPatient.jsp?id=<%=rs.getString("id") %>">Check Patient</a></td>
