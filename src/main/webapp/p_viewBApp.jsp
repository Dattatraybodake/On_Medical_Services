			...
			<div class="col-lg-12">
				<div class="row">
					<div class="col-lg-12" align="center">
						<h2>Doctor Appointment Status</h2>
						<hr />
							...
							<table class="table">
								...
								<%
									String email=session.getAttribute("email").toString();
												...
												PreparedStatement ps  = con.prepareStatement("SELECT * FROM `appoinment_details` where user_email='"+email+"' ORDER BY app_date DESC ");
								...
								<tr>
									...
									<td>
										<%
									if(rs.getString("status").equals("Waitting"))
									{
									%> <a href="CancelRequest?id=<%=rs.getString("id")%>">Cancel
											Appointment</a> <%}
									else if(rs.getString("status").equals("Cancel"))
									{
									%><p style="color: red;">Already Cancel</p> <%
									} 
									else if(rs.getString("status").equals("Accept"))
									{
									%><p style="color: green;">Accept</p> <%}
									
									else if(rs.getString("status").equals("Check"))
									{
										%> <a
										href="patient_checkPrescription.jsp?id=<%=rs.getString("id")%>">Check
											Presctiption</a> <%
									}
