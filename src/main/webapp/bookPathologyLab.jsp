...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				<h2 align="center">Appointment Booking Details</h2>
				<hr />
				<p align="right">
		...
		<div class="row">
			...
			<div class="col-lg-6">
				<div class="table-responsive">
					<form action="SendRequestToLab" method="POST">
						...
						<table class="table" align="center">
							...
							<tr>
								...
								<td><select name="app_id" class="form-control">
									...
									HashMap<String,String> report=gf.getLabReport(user_email);
									for(Map.Entry m : report.entrySet())
									 {
										String val= m.getValue().toString();
										String arr[]=val.split(",");
									%>
										<option value="<%=m.getKey()%>,<%=arr[0]%>"><%=arr[1]%></option>
										<%
											}
										%>
								</select></td>
							...
							<tr>
								...
								<td><input type="date" name="app_date" readonly="readonly"
									value="<%=app_date%>" class="form-control"></td>
							</tr>
							<tr>
								<th>Time Slot</th>
								<td><select name="time_slot" class="form-control">
										<%
											//GlobalFunction gf=new GlobalFunction();
											HashMap<String,String> slot=gf.getLabBusyTime(d_id,app_date);
