			...
			<div class="col-lg-12">
				<div class="row">
					<div class="col-lg-6" align="right">
						<img alt="" src="images/labr.png" style="width: 80%">
					</div>
					<%
					...
					HashMap<String,String> lb_detail=gf.getPathologyReportDetail(id);
					
					String pname=lb_detail.get("pname");
					String refer_by_dr_id=lb_detail.get("refer_by_dr_id");
					
					%>
					
					<div class="col-lg-6" align="center">
						<h2>Upload Pathology Lab Report</h2>
						<hr />	
							...
							<table align="center" class="table">
								<tr>
									...
									<input type="text" readonly="readonly" 
										class="form-control" value="<%=id %>--<%=pname %>"  required></td>
								</tr>
								<tr>
									<th>File</th>
