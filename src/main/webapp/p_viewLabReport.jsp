		...
		<div class="row">
			<div class="col-lg-12">
				<div class="row">
					...
					<h2>Pathology Lab Report Status</h2>
					<hr/>
					...
					<%
						...
						PreparedStatement ps  = con.prepareStatement("SELECT * FROM `pathology_report` where patient_id='"+email+"' ORDER BY id DESC");
						...
						while(rs.next())
						{
							...
							HashMap<String,String> d_details=gf.getDr_Details(rs.getString("dr_id"));
