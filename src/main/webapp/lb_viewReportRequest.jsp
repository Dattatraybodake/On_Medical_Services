		...
		<div class="row">
			<div class="col-lg-12">
				<div class="row">
					...
					<h2>Pathology Lab View Request </h2>
					<hr/>
					...
					<%
					 String id=session.getAttribute("id").toString();
						...
						PreparedStatement ps  = con.prepareStatement("SELECT * FROM `pathology_report` where dr_id='"+id+"'");
						...
						while(rs.next())
						{
							...
							HashMap<String,String> d_details=gf.getDr_Details(rs.getString("refer_by_dr_id"));
						...
						<tr>
							...
							{
							%>
							<a href="UpdateLabReqStatus?id=<%=rs.getString("id")%>&s=Accept">Accept</a>|<a href="UpdateLabReqStatus?id=<%=rs.getString("id")%>&s=Reject">Reject</a>
							 
							<%
							}
							else if(rs.getString("status").equals("Accept"))
							{
							%>
							<a href="lb_UploadReport.jsp?id=<%=rs.getString("id")%>">Upload Report</a>
							<%	
							}
